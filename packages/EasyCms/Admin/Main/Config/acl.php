...
return [
    [
        'key' => 'information',
        'name' => 'admin::app.left-sidebar.information',
    ...
    [
        'key' => 'order',
        'name' => 'admin::app.left-sidebar.orders.title',
        'route' => 'admin.login',
        'sort' => 1,
        'icon-name' => 'orders.png',
    ],

    [
        'key' => 'shop',
        'name' => 'admin::app.left-sidebar.shop.title',
        'route' => 'admin.login',
        'sort' => 1,
        'icon-name' => 'shop.png',
    ],
    ...
    [
        'key' => 'settings',
        'name' => 'admin::app.left-sidebar.settings.title',
